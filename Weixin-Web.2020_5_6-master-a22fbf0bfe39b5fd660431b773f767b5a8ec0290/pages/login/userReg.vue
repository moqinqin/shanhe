<template>
	<view>
		...
		<view class="login_form">
			...
			<view class="input">
				<view class="img">
					<image style="width:20px;height: 25px;" src="../../static/icons/icon_user.png" />
				</view>
				<input type="text" v-model="hostboxname"  placeholder="请定义主机名称">
			</view>
			<view class="line" />
			<view class="input">
				<view class="img">
