<template>
	<view>
		<view class="example-body">
			<view class="uni-list">
				<view class="uni-list-cell uni-list-cell-pd">
					...
					<input v-model="scene.name" type="text" style="text-align: right;"/>
				</view>
			</view>	
			<view class="uni-list">
				<view class="uni-list-cell uni-list-cell-pd">
		...
		<view class="addButton">
			<image src="../../static/index/add.png" @tap="addHardware">
			</image>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		onLoad(e) {
			let _this = this;
			_this.id = e.id;
			apiUtils.getScenesDetailsById({id: _this.id}, function(res){
				_this.scene = res.scene;
